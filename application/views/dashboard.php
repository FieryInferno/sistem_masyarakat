...
<div class="col-md-4">
  <div class="card">
    ...
    <div class="card-body text-white bg-success">
      <p class="card-text text-light"><a href="<?= base_url(); ?>warga/vaksin_covid" class="text-white">Lihat Detail</a></p>
    </div>
  </div>
</div>
<div class="col-md-4">
...
<div class="col-md-4">
  <div class="card">
    ...
    <div class="card-body text-white bg-success">
      <p class="card-text text-light"><a href="<?= base_url(); ?>warga/saran_perubahan.html" class="text-white">Lihat Saran Perubahan</a></p>
    </div>
  </div>
</div>
<div class="col-md-4">
